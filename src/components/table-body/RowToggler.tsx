        ...
        <i data-level={level}>
          {level <= 0 ? (
            <svg viewBox="0 0 1024 1024">
              <path d="M266.24 420.0448a30.8736 30.8736 0 0 1 52.736-21.8624L512 591.0016l192.9728-192.8192a30.8736 30.8736 0 1 1 43.7248 43.7248l-214.8352 214.6304a31.0272 31.0272 0 0 1-43.776 0L275.3024 441.9072a30.8736 30.8736 0 0 1-9.0624-21.8624z" />
            </svg>
          ) : (
            <svg viewBox="0 0 1024 1024">
